...
class SettingsDialog(QDialog):
    def __init__(self, parent):
        ...
        tagging_layout.addWidget(tag_separator_line_edit, 1, 1,
                                 Qt.AlignmentFlag.AlignLeft)
        ...
        insert_space_after_tag_separator_check_box.stateChanged.connect(
            self.show_restart_warning)
        tagging_layout.addWidget(insert_space_after_tag_separator_check_box,
        ...
        autocomplete_tags_check_box.stateChanged.connect(
            self.show_restart_warning)
        tagging_layout.addWidget(autocomplete_tags_check_box, 3, 1,
                                 Qt.AlignmentFlag.AlignLeft)
        ...
        files_layout.addWidget(file_types_line_edit, 0, 1,
                               Qt.AlignmentFlag.AlignLeft)
        ...
        files_layout.addWidget(models_directory_button, 2, 1,
                               Qt.AlignmentFlag.AlignLeft)
